    ...
    return html.Div(
        ...
        children=[
            html.Div(
                ...
                children=[
                    html.H5("CU-Unite"),
                    html.H6("A Community is Built by Individuals"),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    html.Button(
                        id="learn-more-button", children="Make Organization", n_clicks=0
                    ),
                    html.Button(
                        id="learn-less-button", children="Sign In/Sign Up", n_clicks=0
                    ),
                ],
            ),
        ],
...
def build_quick_stats_panel():
    global org_state
    if org_state == 0:
        org_name = html.H1('PYGMALIION')
        org_members = "170"
        org_events = "15"
    else:
        org_name = html.H1('HABITAT FOR HUMANITY')
        org_members = "425"
        org_events = "128"
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("Organization Statistics"),
                    html.Div(
                        id="metric-div",
                        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("Total Contributions"),
                    generate_piechart(),
                ],
            ),
        ],
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                # className="four columns",
                children=[
                    generate_section_banner("Community Statistics"),
                    generate_piechart_community(),
                    generate_bar_community()
                ],
            ),
        ],
    )
...
def generate_bar_community():
    ...
    return dcc.Graph(
        ...
        figure={
            ...
            'data': [
                {'x': l, 'y': [2, 2, 3, 6, 6, 7, 6, 7, 8, 11, 13, 12, 15, 15, 16, 16, 16, 20, 20, 21], 'type': 'bar', 'name': 'Attendees'},
                {'x': l, 'y': [3, 4, 3, 4, 5, 6, 7, 7, 11, 9, 10, 13, 13, 14, 16, 15, 16, 20, 21, 19], 'type': 'bar', 'name': '# Projects'},
                {'x': l, 'y': [2, 2, 2, 5, 5, 6, 6, 9, 11, 9, 13, 14, 13, 13, 15, 15, 17, 17, 20, 19], 'type': 'bar', 'name': 'Volunteers'},
                {'x': l, 'y': [2, 4, 2, 4, 6, 7, 6, 9, 9, 11, 12, 11, 15, 16, 14, 16, 19, 17, 18, 19], 'type': 'bar', 'name': 'lbs recycled'},
                {'x': l, 'y': [2, 1, 2, 3, 6, 7, 6, 8, 10, 11, 12, 13, 13, 13, 17, 18, 16, 20, 19, 20], 'type': 'bar', 'name': 'Meals Given'},
            ],
            'layout': {
...
def generate_piechart_community():
    return dcc.Graph(
        id="piechartcommunity",
        figure={
            "data": [
                {
                    "labels": ['Attendees','# Projects','Volunteers','Meals Given','lbs recycled'],
                    "values": [10,8,5,4,5],
                    "type": "pie",
                    "marker": {"line": {"color": "white", "width": 1}},
                    "hoverinfo": "label",
...
def generate_metric_list_header():
    return generate_metric_row(
        ...
        {"id": "m_header_1", "children": html.Div("Statistic")},
        {"id": "m_header_2", "children": html.Div("Count")},
        {"id": "m_header_3", "children": html.Div("History")},
        # {"id": "m_header_4", "children": html.Div("OOC%")},
        {"id": "m_header_4", "children": html.Div("Lifetime")},
        {"id": "m_header_5", "children": html.Div("%OOC")},
        {"id": "m_header_6", "children": "Verified"},
    )
    ...
    return generate_metric_row(
        ...
        None,
        {
            ...
            "children": html.Button(
                ...
                children=item,
                title="Click to visualize live Statistic chart",
                n_clicks=0,
            ),
        },
        ...
        },
        {
            ...
            "children": daq.Indicator(
                id=indicator_id, value=True, color=c, size=12
            ),
        },
    )
...
def build_chart_panel():
    return html.Div(
        ...
        children=[
            generate_section_banner("Statistic Breakdown"),
            dcc.Graph(
...
def render_tab_content(tab_switch, stopped_interval):
    if tab_switch == "tab1":
        return build_individual_tab(), stopped_interval
        ...
        return(
            build_community_panel(),
            # html.Div(
            #     id="community-container",
            #     children=[
            #         html.Div(
            #             id="graphs-container",
            #             children=[build_community_panel()],
            #         ),
            #     ],
            # ),
            stopped_interval,
